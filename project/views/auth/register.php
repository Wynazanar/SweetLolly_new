...
<main>
    <div class="container auth-match-wrap">
        ...
        <section class="beauty-hero">
            ...
            <p>Статическая страница регистрации теперь выглядит как основа сайта.</p>
        </section>
        ...
        <div class="auth-match-grid">
            ...
            <section class="auth-match-card">
                <div class="auth-match-tabs">
                    <a class="beauty-btn secondary purple" href="/SweetLolly_new/login/">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a class="beauty-btn" href="/SweetLolly_new/register/">
                ...
                <p class="muted">Создай профиль для личного кабинета SweetLolly.</p>

                <form method="POST" action="/SweetLolly_new/register/" class="auth-match-form" id="serverReg">
                    ...
                    <div class="auth-match-field">
                        ...
                        <input name="username" type="text" placeholder="Например: Steve" required
                    ...
                    <div class="auth-match-field">
                        <label>Email</label>
                        <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4-8 5-8-5V6l8 5 8-5z"></path>
                        </svg>
                    ...
                    <div class="auth-match-field">
                        ...
                        <input name="password_confirm" type="password" placeholder="Ещё раз пароль" required
                            minlength="8" autocomplete="new-password">
                    </div>

                    <button class="beauty-btn" type="submit" style="width: 100%;">Зарегистрироваться</button>
                </form>

                <div class="auth-match-links">
                    <a href="/SweetLolly_new/login/">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2a5 5 0 1 0 0 10 5 5 0 1 0 0-10M4 22h16c.55 0 1-.45 1-1v-1c0-3.86-3.14-7-7-7h-4c-3.86 0-7 3.14-7 7v1c0 .55.45 1 1 1"></path>
                        </svg>
                        Уже есть аккаунт
