  ...
  <main>
    <div class="container">
      ...
      <section class="beauty-grid">
        ...
        <a class="beauty-card" href="./games/">
          <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            <path
              d="M19 2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h11c2.76 0 5-2.24 5-5V4c0-1.1-.9-2-2-2m-7 16h-2v2H8v-2H6v-2h2v-2h2v2h2zm3 1c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m2-2c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m1-5H6V5h12z">
            </path>
        ...
        <a class="beauty-card" href="./candies/">
          <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            <path
      ...
      <section class="lolli-card">
        <div class="two-col">
          <div>
            <h2 style="font-weight: 900; font-size: 32px;">Что нового</h2>
            <p class="muted" style="margin-block: 8px 10px;">Сайт приведён к единому стилю: аккуратные карточки,
              адаптивные блоки, улучшенные формы,
              копирование IP, обновлённый кабинет и раздел леденцов.</p>
            <div>
              <a class="beauty-pill" href="./news/cosmetics/">😱 Косметика</a>
              <a class="beauty-pill" href="./help/">Помощь</a>
              <a class="beauty-pill" href="./rules/">Правила</a>
            </div>
          </div>
