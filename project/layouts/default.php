...
<body>
	...
	<section class="hero-nav">
		<div class="container">
			<div class="hero-row"><a href="./" class="site-logo" aria-label="SweetLolly"></a>
				<div class="promo">
				...
				<div class="row">
					<div class="col-12 col-md-6 footer_about">
						...
						<div class="footer-text">Добро пожаловать на сайт сервера SweetLolly :)<br>Новости, форум,
							режимы, помощь и
							личный кабинет — всё в одном месте.<br><br>Email для связи: feedback.swetlolly@gmail.com
						</div>
					</div>
					<div class="col-12 col-md-3 footer_navigation">
						...
						<ul>
							...
							<li><a href="/SweetLolly_new/fill/">Леденцы</a></li>
					...
					<div class="col-12 col-md-3 footer_community">
						...
						<ul>
							...
							<li><a href="https://vk.com.server">Группа ВК</a></li>
							<li><a href="https://discord.com/invite/JyEgjty">Discord</a></li>
							<li><a href="https://www.youtube.com/channel/UCT3yn8JMie5EVhBIBq7A7Nw">YouTube</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row align-items-center">
					...
					<!-- <div class="col-12 col-md-6 pay_logos text-md-right"><img src="./assets/logo-visa.png"
							style="height:17px"><img src="./assets/logo-mastercard.png" style="height:24px"><img
							src="./assets/logo-paypal.png" style="height:19px"><img src="./assets/logo-apple-pay.png"
							style="height:20px"><img src="./assets/logo-google-pay.png" style="height:20px"></div> -->
				</div>
			</div>
		</div>
	</footer>
